...
The pre-v1 product program from v0.59.4 through v0.59.18 contains 15 planning
units, or approximately 90 person-weeks at the roadmap sizing rule. That is a
...
10. **Pre-v1 scope is frozen after approval.** No new pre-v1 capability
    milestone may be added. New work must split an oversized milestone, correct
    a violated v1 contract, resolve a P0/P1 defect, or move to v1.x.
...
- Any new public surface (SQL syntax, CLI command, config key, system table) is
  documented in `docs/`.
- Every public capability is labeled `Supported`, `Compatible, unverified`, or
   `Unsupported`; the label describes the tested contract, not an optimistic
   inference from a protocol implementation.
...
| v1.0 Release | after v0.59.18 | The exact signed candidate artifacts pass every bounded automated qualification gate with zero open P0/P1 defects; optional extended soaks may supplement, but do not replace or block, the automated evidence; `v1.0.0` is then tagged. |
...
After v0.59.18, create `v1.0.0-rc.1` from one protected source SHA and freeze its
...
| Phase 17 — Production Readiness & 1.0 Finalization | v0.53 – v0.59.18 (including the v0.53.1–v0.59.18 sub-versions added by the 2026-08-12, 2026-08-18, and 2026-08-19 reviews) | Continuous verification + artifact-bound, no-skip automated qualification before RC1; product polish, diagnostics, executable documentation, public-path proof closure through v0.59.13, SQL semantics and system-limits proof at v0.59.14, type-completeness proof at v0.59.15, lifecycle and deployment work through v0.59.17, and capacity-estimator calibration at v0.59.18; optional extended soaks are supplemental only; v0.56 additionally proven by a `SimRuntime` mixed-version scenario |

Seventy-four versions at ~6 person-weeks each is the full path from an empty
