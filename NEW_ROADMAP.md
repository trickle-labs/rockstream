...
| v1.0 Release ✅ Done | v0.59 | All v0.1–v0.58 features integrated; the seven v1 release gates (correctness, recovery, bounded resources, operability, upgradeability, security, performance stability) are each signed off against a named artifact; 2-week continuous chaos cycle passes with zero P0/P1 bugs; `v1.0.0` tagged. |
